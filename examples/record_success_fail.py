...
def main(_):
    ...
    env = config.get_environment(fake_env=False, save_video=False, classifier=False) #qui False ovviamente perchè questo script 
    # serve proprio per salvare succ/fails per addestrare il classifier !!!.. quindi non può chiamare il classifier che non esiste ancora e non serve qua
