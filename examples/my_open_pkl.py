...
file_path = "demo_data/A_my_UR_TEST_2_demos_second_completed.pkl" # 31316 elementi (?????)
...
def show_pkl_content(file_path):
    ...
    if isinstance(data, list):
        ...
        print("Tipo del primo elemento:", type(data[element_to_pick]) , " \n")
        print("Contenuto del primo elemento: \n\n ", data[element_to_pick])
