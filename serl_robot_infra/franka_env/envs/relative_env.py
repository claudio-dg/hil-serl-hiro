...
class RelativeFrame(gym.Wrapper):
    ...
    def step(self, action: np.ndarray):
        ...
        # IN TEORIA A ME STA PARTE DI TRASF. DELL'AZIONE NON SERVE... DO GIÀ IN PASTO A ROBOT CORRETTAMENTE QUINDI ME NE FREGO (?)
        ...
        # Update adjoint matrix (PER POSA ATTUALE TIMESTEP "i")
...
######################### PROBLEMA ... non ho capito ancora perchè,
#  ma il mio env nel momento in cui chiami reset ha tutto vuoto
# quindi qui crasha perchè prova ad accedere ad una chiave  [state] che non esiste
