...
```
Please, refer to the README of [hil_serl_hiro_utils](https://github.com/claudio-dg/my_cpp_py_pkg/blob/master/README.md) repository to learn more about how to use the XBOX Controller for this project.
